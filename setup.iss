...
; 2. Copia o ambiente virtual inteiro para a pasta "runtime" dentro do diretório de instalação
Source: "C:\Users\Guto\AppData\Local\pypoetry\Cache\virtualenvs\hy-wx-demo-V3u_4eSN-py3.13\*"; DestDir: "{app}\runtime"; Flags: recursesubdirs createallsubdirs ignoreversion
